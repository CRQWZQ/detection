...
public class SimpleHttpUtils {
    ...
    private static final String USER_AGENT_FOR_PC = "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.146 Safari/537.36";
    ...
    private static String[] heards= {"Mozilla/5.0 (Windows NT 5.1; U; en; rv:1.8.1) Gecko/20061208 Firefox/2.0.0 Opera 9.50",
     ...
     * 切换请求浏览器
     */
    public static Map<String,String> userAgentMap() {
        Map<String, String> map = new HashMap<>();
        map.put("User_Agent",heards[(int)(Math.random() *14)]);
        return map;
    }
